...
import { SelectedAuthorsCategoriesProps } from 'types'
...
const SelectAuthorsCategories: React.FC<SelectedAuthorsCategoriesProps> = ({
  book,
  name,
  setBook,
  categories,
...
export default SelectAuthorsCategories